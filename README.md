...
calculation theme yet). Read [the complete documentation]() for more
information.
...
[there]() (should be written in english, french or german).
...
pot files to get [here]() (see explanations about their respective roles
[there]()). You can use an editor like [poedit](https://poedit.net/) or
any other you like better, to create po files from them and start to
translate.

If you want to add missing translations, or to correct some, you can
find the po files in the subdirectories [here]().
...
(2) Using `pkg`, you'll have to install `texlive-full`; if you wish to
    install only the relevant LaTeX packages, you'll have to browse the
    ports, I haven't done this yet so cannot tell you exactly which ones
    are necessary.
(3) Complete list of provided sheets:
  ...
  geometry        right        converse-and-contrapositive-of-pythagorean-
                  triangle     theorem-short-test

  geometry        right        pythagorean-theorem-short-test
                  triangle     

  mental\_calcula lev11\_1     divisions
  tion                         

  mental\_calcula lev11\_1     mini\_problems
  tion                         

  mental\_calcula lev11\_1     multi\_11\_15\_25
  tion                         

  mental\_calcula lev11\_1     multi\_decimal
  tion                         

  mental\_calcula lev11\_1     multi\_hole\_any\_nb
  tion                         

  mental\_calcula lev11\_1     multi\_hole\_tables2\_9
  tion                         

  mental\_calcula lev11\_1     multi\_reversed
  tion                         

  mental\_calcula lev11\_1     ranks
  tion                         

  mental\_calcula lev11\_1     tables2\_9
  tion                         

  mental\_calcula lev11\_1     test\_11\_1
  tion                         

  mental\_calcula lev11\_2     multi\_divi\_10\_100\_1000
  tion                         

  mental\_calcula lev11\_2     operations\_vocabulary
  tion                         

  mental\_calcula lev11\_2     polygons\_perimeters
  tion                         

  mental\_calcula lev11\_2     rectangles
  tion                         

  mental\_calcula lev11\_2     test\_11\_2
  tion                         

  numeric         fractions    fraction-simplification
  calculation                  

  numeric         fractions    fractions-product-and-quotient
  calculation                  

  numeric         fractions    fractions-sum
  calculation                  
  ------------------------------------------------------------------------
