...
# -*- coding: utf-8 -*-
#
# mathmaker documentation build configuration file, created by
# sphinx-quickstart on Mon Jun 27 18:20:56 2016.
#
...
#          'mathmaker is required. Either install the package into your '
...
htmlhelp_basename = 'mathmakerdoc'
...
man_pages = [
    (master_doc, 'mathmaker', 'mathmaker Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mathmaker', 'mathmaker Documentation',
     author, 'mathmaker', 'One line description of project.',
     'Miscellaneous'),
]
