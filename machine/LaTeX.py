...
chosen language (" + language + ") is not implemented yet in %(software_ref)s, \
which will try to use the language entry from the configuration file instead") \
% {'software_ref':software.NAME})
...
%(software_ref)s, which will use the english package instead"))
    ...
    def write_document_header(self):
        ...
        result += "% " + _( \
              ...
              % {'document_format':latex.FORMAT_NAME_PRINT,
...
please use this command :") + "\n"
        ...
        result += "\\newcounter{n}" + "\n"
        result += "% " + _("Definition of the %(exercise)s command, \
which will insert the word %(Exercise)s in bold, with its number and \
