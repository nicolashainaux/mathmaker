...
def __main__():
    ...
    db_rows = [('km', 'hm', 'right', 'length', 1, 1, 0),   # simple units,
               ...
               ('hL', 'dL', 'right', 'capacity', 3, 1, 0),
               ('daL', 'cL', 'right', 'capacity', 3, 1, 0),
               ('dL', 'hL', 'left', 'capacity', 3, 1, 0),
               ('cL', 'daL', 'left', 'capacity', 3, 1, 0),
               ('hg', 'dg', 'right', 'mass', 3, 1, 0),
               ('dag', 'cg', 'right', 'mass', 3, 1, 0),
               ('dg', 'hg', 'left', 'mass', 3, 1, 0),
               ('cg', 'dag', 'left', 'mass', 3, 1, 0),
